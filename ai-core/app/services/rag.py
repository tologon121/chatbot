...
_DEMO_FALLBACK_REPLY = {
    ...
    "EN": "Demo mode: GEMINI_API_KEY isn't configured, so I'm replying with a stub.",
    "KG": "Демо-режим: GEMINI_API_KEY жок, ошондуктан шаблон менен жооп берем.",
}
